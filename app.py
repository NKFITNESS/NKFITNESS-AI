...
muscle_workouts = {
    ...
    "Biceps": [("Barbell Curls", "https://www.youtube.com/watch?v=kwG2ipFRgfo"),
               ...
               ("Cable Curls", "https://www.youtube.com/watch?v=ykJmrZ5v0Oo")],
    "Triceps": [("Tricep Dips", "https://www.youtube.com/watch?v=0326dy_-CzM"),
    ...
    "Legs": [("Barbell Squats", "https://www.youtube.com/watch?v=Dy28eq2PjcM"),
             ("Lunges", "https://www.youtube.com/watch?v=QOVaHwm-Q6U"),
             ("Leg Press", "https://www.youtube.com/watch?v=IZxyjW7MPJQ")],
    "Core": [("Plank Holds", "https://www.youtube.com/watch?v=pSHjTRCQxIw"),
...
if tabs == "Workout Plan":
    ...
    for muscle, workouts in muscle_workouts.items():
        ...
        for ex_name, link in random.sample(workouts, 2):
            st.write(f"{ex_name}: [Watch Video]({link})")
...
# Other Tabs Placeholder (implement them if needed)
elif tabs == "Diet Plan":
