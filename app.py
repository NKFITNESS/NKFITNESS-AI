...
plans = {
    "Lose Weight": {
        "Beginner": ["Jumping jacks", "Squats", "Plank"],
        "Intermediate": ["Burpees", "Mountain climbers", "Lunges"],
        "Advanced": ["HIIT circuits", "Sprints", "Box jumps"]
    },
    "Gain Muscle": {
        "Beginner": ["Push-ups", "Dumbbell rows", "Leg press"],
        "Intermediate": ["Bench press", "Pull-ups", "Barbell squat"],
        "Advanced": ["Deadlift", "Weighted dips", "Clean & press"]
    },
    "Maintain Fitness": {
        "Beginner": ["Walking", "Bodyweight squats", "Shoulder taps"],
        "Intermediate": ["Jogging", "Push-ups", "Resistance bands"],
        "Advanced": ["CrossFit routines", "Jump rope", "Mobility drills"]
    }
}
...
if tabs == "Workout Plan":
    st.header(f"Workout Plan for {level} - Goal: {goal}")
    for exercise in plans[goal][level]:
